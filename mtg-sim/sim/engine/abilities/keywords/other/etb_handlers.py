...
def _ravenous_detail(game: GameState, permanent: Permanent) -> str | None:
    return apply_ravenous_etb(game, permanent)


def _soulbond_detail(game: GameState, permanent: Permanent) -> str | None:
